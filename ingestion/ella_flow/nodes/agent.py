"""The Ella agent node — the centerpiece. It thinks with a model and is grounded by
...
@node
class EllaAgent(NodeHandler):
    node_type = NodeType(
        type="agent.ella", category="Agents", label="Ella", icon="🤖",
        description="Ella reasons over the input, grounded by her attached capabilities.",
        ...
        output_fields=[
            OutputField(key="text", type="string", description="Ella's answer"),
