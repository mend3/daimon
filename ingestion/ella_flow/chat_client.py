...
/api/chat endpoint; reads Ella's system prompt from ~/.hermes/SOUL.md when present."""
...
def soul_prompt() -> str:
    return _SOUL.read_text() if _SOUL.exists() else "You are Ella, a warm, capable companion."
