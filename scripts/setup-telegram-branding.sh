#!/usr/bin/env bash
# Set Ella's Telegram bot branding (name, descriptions, menu button) via the Bot
...
SHORT="Ella — your private, local AI companion. I think with you, remember what matters, and help you get things done."
DESC="Hi, I'm Ella — a private AI companion running on local, private infrastructure. I'm a thinking partner and an operator: I remember our work, search the web, read images and voice notes, and help you decide and execute — anticipating what comes next. Send me a message to begin."

curl -fsS "${API}/setMyName" --data-urlencode "name=Ella" >/dev/null
...
echo "Ella's Telegram branding applied."
